        ...
        <div class="has-feedback">
            <form action="${pageContext.request.contextPath}/record/searchRecords" method="post">
                <c:if test="${USER_SESSION.role =='ADMIN'}">
                    预约人：<input name="borrower" value="${search.borrower}">&nbsp&nbsp&nbsp&nbsp
                </c:if>
                场所名称：<input name="bookname" value="${search.bookname}">&nbsp&nbsp&nbsp&nbsp
    ...
    <div class="table-box">
        ...
        <table id="dataList" class="table table-bordered table-striped table-hover dataTable text-center">
            ...
            <tr>
                ...
                <th class="sorting_asc">预约场所名称</th>
